      ...
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {cryptoData ? (
          ...
          <div className="w-full min-h-[50vh] flex justify-center items-center">
            <div
              className="w-8 h-8 border-4 border-solid border-red rounded-full border-b-gray-200 animate-spin"
              role="status"
            />
            <span className="text-base ml-2">this broke ill fix it eventually</span>
          </div>
        ) : error.data || error.search ? (
